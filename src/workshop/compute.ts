...
export async function solve(definitionPointer: string, inputs: Record<string, any>) {
  console.log(`🔗 Calling Compute at ${COMPUTE_URL}/grasshopper`);
  console.log(`📝 Definition: ${definitionPointer}`);
  ...
  try {
    ...
    console.log(`✅ Compute successful, result size:`, JSON.stringify(result).length);
    return result;
