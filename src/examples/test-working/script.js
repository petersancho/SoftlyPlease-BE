...
const definition = 'value_list.gh'

// setup input change events
const number_select = document.getElementById( 'RH_IN:number' )
number_select.addEventListener( 'change', onSliderChange, false )
...
async function compute(){
  ...
  url.searchParams.append('RH_IN:number', number_select.value)
