...
const config = {
  ...
  rhino: {
    url: process.env.COMPUTE_URL || process.env.RHINO_COMPUTE_URL || 'http://softlyplease.canadacentral.cloudapp.azure.com/',
    apiKey: process.env.RHINO_COMPUTE_KEY || 'p2robot-13a6-48f3-b24e-2025computeX',
    timeout: 30000,
    retries: 3
  },
